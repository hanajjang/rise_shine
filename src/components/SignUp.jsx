                      ...
                      <div className="space-y-2 max-h-56 overflow-y-auto pr-1">
                        {cellGroups.map((group, idx) => (
                          <button
                            ...
                            className={`w-full text-left px-5 py-3 rounded-xl border flex justify-between items-center transition-all cursor-pointer font-sans ${formData.cellGroup === group
